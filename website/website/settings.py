...
SECRET_KEY = 'django-insecure-o^g_8-kkha2e(&cld+99hs!t*=_f%4(bl$@#fv7sk*3s$3x%j='
...
# STATIC_URL = 'static/'
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / "static"]  # Directory for your static files (CSS, JS, images)
